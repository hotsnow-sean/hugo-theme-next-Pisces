...
NexT.motion.middleWares = {
  ...
  postList: function() {
    const sequence = [];
    const post_block = "fadeIn";
    const post_header = "fadeInDown";
    const post_body = "fadeInDown";
    const coll_header = "fadeInLeft";
  ...
  sidebar: function() {
    ...
    const sidebarTransition = "fadeInUp";
